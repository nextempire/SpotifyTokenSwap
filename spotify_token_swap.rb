...
CLIENT_ID = ENV.fetch("CLIENT_ID") # TODO: Get it from Spotify
CLIENT_SECRET = ENV.fetch("CLIENT_SECRET") # TODO: Get it from Spotify
CLIENT_CALLBACK_URL = ENV.fetch("CLIENT_CALLBACK_URL") # TODO: Get it from Spotify
